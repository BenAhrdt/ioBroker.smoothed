class calculationtypes{
	...
	calculateStandardDeviation(channel){
		...
		this.adapter.log.debug(`New standard deviation:  ${channel.currentStandardDeviation}`);
	...
	movingAverage(channel){
		this.adapter.log.debug("----- start calculation moving average -----");
		...
		this.adapter.log.debug("----- end calculation moving average -----");
	...
	lowpassPt1(channel){
		this.adapter.log.debug("----- start calculation Pt1 -----");
		this.newValueToArray(channel);
		let smoothtime = 0;
		...
		this.adapter.log.debug("----- end calculation Pt1 -----");
		this.calculateStandardDeviation(channel);
	}
	...
	newValueToArray(channel){
		this.adapter.log.debug("----- start new value to array -----");
		...
		this.adapter.log.debug("Whole timedifference in the array: " +(channel.lastArray.value[channel.lastArray.value.length - 1].ts - channel.lastArray.value[0].ts) / 1000 + "s.");
